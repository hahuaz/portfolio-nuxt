<template>
  <div class="cd-fold-content">
    <transition name="glide-up-fast" appear>
      <div>
        <div class="grid grid-cols-1 justify-items-center">
          <h1 class="bottom__line--blue mt-24 mb-6 inline-block">Languages</h1>
        </div>
        <div
          class="
            grid grid-cols-3
    ...
    <transition name="glide-up-normal" appear>
      <div>
        <div class="grid grid-cols-1 justify-items-center">
          <h1 class="bottom__line--blue mt-24 mb-6 inline-block">Structures</h1>
        </div>
        <div
          class="
            grid grid-cols-3
        ...
        >
          ...
          <div>
            <img class="w-16 h-16" src="~/assets/image/mongodb.png" alt="" />
          ...
          <div>
            <img class="w-16 h-16" src="~/assets/image/tailwind.png" alt="" />
